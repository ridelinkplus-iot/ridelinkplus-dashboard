...
const styles: Record<string, CSSProperties> = {
  ...
  sidebarGlow: {
    ...
    height: "100%",
    background:
      "linear-gradient(180deg, transparent, var(--medium-teal), transparent)",
    pointerEvents: "none"
  },
  sidebarContent: {
    flex: 1,
    ...
    padding: "28px",
    scrollbarWidth: "thin",
    scrollbarColor: "var(--medium-teal) rgba(255, 255, 255, 0.05)"
  },
  panel: {
    background: "rgba(0, 0, 0, 0.2)",
  ...
  panelGlow: {
    ...
    height: "1px",
    background:
      "linear-gradient(90deg, transparent, var(--medium-teal), transparent)"
  },
  panelTitle: {
    color: "white",
    fontWeight: 700,
  ...
  headerButton: {
    ...
    border: "none",
    boxShadow:
      "0 8px 20px rgba(139, 92, 246, 0.3), 0 0 0 1px rgba(255, 255, 255, 0.1) inset",
    cursor: "pointer",
    transition: "all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)",
    fontSize: "15px",
    letterSpacing: "0.3px"
  ...
  busCard: {
    background:
      "linear-gradient(135deg, rgba(0, 126, 126, 0.15) 0%, rgba(48, 152, 152, 0.15) 100%)",
  ...
  mapContainer: { flex: 1, position: "relative", height: "100%" },
  legend: {
    position: "absolute",
    bottom: "32px",
    left: "32px",
...
export default function App(): JSX.Element {
  ...
  return (
    <div style={styles.container}>
      <div style={styles.mainContent} className="main-content-container">
          ...
          <div style={styles.sidebarContent}>
            ...
            {(searchStatus === "not_found" || searchStatus === "error") && (
              ...
              >
                ...
                <h3 style={{ ...styles.panelTitle, color: "#fca5a5" }}>
                  <svg
        ...
        <main style={styles.mapContainer}>
          ...
          <div style={styles.legend} className="legend-container bg-black">
            <h4
              style={{
                color: "white",
                fontWeight: 700,
...
function SearchPanel({
  ...
  return (
    <div style={styles.panel}>
      ...
      <button onClick={searchRoute} disabled={loading} style={styles.button}>
        {loading ? (
          <>
            <svg
              style={{
